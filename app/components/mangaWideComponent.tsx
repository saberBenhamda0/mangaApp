    ...
    >
      ...
      >
        ...
        >
          ...
          <Text style={styles.subTitlevalue}>5.87 #####</Text>
        </View>
        <Text style={styles.description}>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore aut
          modi sed optio veniam accusamus maiores ipsum impedit quibusdam,
          rerum, iste expedita, assumenda ea et quisquam at voluptas nisi
          sapiente!
        </Text>
      </View>
